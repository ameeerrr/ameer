...
const translaition = {
    ...
    ar: {
        ...
        services_h3_4:"خدمات استضافة النطاق والمواقع",
        services_p_4:"تقدم الشركة  جميع أنواع أسماء النطاقات وخدمات استضافة المواقع على خوادم سريعة وآمنة ومؤمنة لاستضافة موقع الويب الخاص بك، مما يسمح لأعمالك بالنمو بشكل دائم بأفضل الأسعار وعلى أفضل خدمات الاستضافة",
